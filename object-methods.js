...
/*
	...
	chave access to the global scope
...
let dog = {
  ...
  speak(owner) {
    return `${this.name} says woof and belogs to ${owner}!`;
  },
...
// let youngerPresidents = [];
// presidents.forEach((i) => {
//   if (i.year > 1900) {
//     youngerPresidents.push(i);
//   }
// });
// console.log(youngerPresidents);

let modernPresidents = presidents.filter((president) => president.year >= 1900);
console.log(modernPresidents);
// presidents.filter((president) => {
//   if (president.year > 1900) {
//     youngerPresidents.push(president);
//   }
// });

// console.log(youngerPresidents);

modernPresidents.forEach((i) => {
  console.log(i.first + i.last);
});
